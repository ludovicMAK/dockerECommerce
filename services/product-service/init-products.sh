...
# Fonction pour vérifier si MongoDB est prêt
wait_for_mongo() {
    echo "Vérification de la disponibilité de MongoDB..."
    until nc -z product-db 27017; do
        echo "MongoDB n'est pas prêt, attente de 5s..."
        sleep 5
    done
